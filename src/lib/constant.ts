...
export const teams: Team[] = [
  {
    ...
    members: [
      { id: 1, name: 'Jaden Miller', position: 'Small Forward', points: 30, rebounds: 10, assists: 5, steals: 2, blocks: 1 },
      { id: 2, name: 'Marcus Green', position: 'Center', points: 25, rebounds: 8, assists: 3, steals: 1, blocks: 0 },
      { id: 3, name: 'Ethan Brooks', position: 'Point Guard', points: 22, rebounds: 7, assists: 4, steals: 2, blocks: 1 },
      { id: 4, name: 'Liam Scott', position: 'Shooting Guard', points: 20, rebounds: 6, assists: 3, steals: 1, blocks: 0 },
      { id: 5, name: 'Noah White', position: 'Power Forward', points: 18, rebounds: 5, assists: 2, steals: 0, blocks: 0 },
      { id: 6, name: 'Oliver Black', position: 'Small Forward', points: 15, rebounds: 4, assists: 1, steals: 0, blocks: 0 },
      ...
      { id: 9, name: 'Benjamin Anderson', position: 'Shooting Guard', points: 8, rebounds: 1, assists: 0, steals: 0, blocks: 0 },
      { id: 10, name: 'Lucas Thomas', position: 'Power Forward', points: 6, rebounds: 0, assists: 0, steals: 0, blocks: 0 },
    ],
    coach: [
  ...
  },
  {
    ...
    members: [
      { id: 1, name: 'Ryan Adams', position: 'Small Forward', points: 28, rebounds: 9, assists: 4, steals: 1, blocks: 1 },
      { id: 2, name: 'Samuel Brooks', position: 'Center', points: 24, rebounds: 10, assists: 2, steals: 0, blocks: 1 },
      { id: 3, name: 'Lucas Evans', position: 'Point Guard', points: 21, rebounds: 6, assists: 5, steals: 2, blocks: 0 },
      { id: 4, name: 'Eli Turner', position: 'Shooting Guard', points: 19, rebounds: 5, assists: 3, steals: 1, blocks: 0 },
      { id: 5, name: 'Owen Harris', position: 'Power Forward', points: 17, rebounds: 4, assists: 2, steals: 0, blocks: 0 },
      { id: 6, name: 'Mason Clark', position: 'Small Forward', points: 15, rebounds: 3, assists: 1, steals: 0, blocks: 0 },
      { id: 7, name: 'Nathan Scott', position: 'Point Guard', points: 13, rebounds: 2, assists: 0, steals: 0, blocks: 0 },
      { id: 8, name: 'Isaac Lewis', position: 'Center', points: 11, rebounds: 2, assists: 0, steals: 0, blocks: 0 },
      { id: 9, name: 'Logan White', position: 'Shooting Guard', points: 9, rebounds: 1, assists: 0, steals: 0, blocks: 0 },
      { id: 10, name: 'Caleb Young', position: 'Power Forward', points: 7, rebounds: 0, assists: 0, steals: 0, blocks: 0 },
    ],
    coach: [
  ...
  },
  {
    ...
    members: [
      { id: 1, name: 'Daniel Green', position: 'Center', points: 30, rebounds: 11, assists: 3, steals: 2, blocks: 2 },
      { id: 2, name: 'Henry White', position: 'Small Forward', points: 25, rebounds: 7, assists: 4, steals: 1, blocks: 0 },
      ...
      { id: 9, name: 'Derek Adams', position: 'Shooting Guard', points: 8, rebounds: 1, assists: 0, steals: 0, blocks: 0 },
      { id: 10, name: 'Tristan White', position: 'Power Forward', points: 6, rebounds: 0, assists: 0, steals: 0, blocks: 0 },
    ],
    coach: [
  ...
  },
  {
    ...
    members: [
      { id: 1, name: 'Ethan Parker', position: 'Center', points: 29, rebounds: 10, assists: 4, steals: 2, blocks: 1 },
      { id: 2, name: 'Jacob Wilson', position: 'Small Forward', points: 24, rebounds: 8, assists: 3, steals: 1, blocks: 0 },
      { id: 3, name: 'Aiden Thomas', position: 'Point Guard', points: 21, rebounds: 6, assists: 5, steals: 1, blocks: 0 },
      { id: 4, name: 'Logan Carter', position: 'Shooting Guard', points: 19, rebounds: 5, assists: 2, steals: 0, blocks: 0 },
      { id: 5, name: 'Cameron Scott', position: 'Power Forward', points: 17, rebounds: 4, assists: 1, steals: 0, blocks: 0 },
      { id: 6, name: 'Nathan Hill', position: 'Small Forward', points: 15, rebounds: 3, assists: 0, steals: 0, blocks: 0 },
      { id: 7, name: 'Tyler Lewis', position: 'Point Guard', points: 13, rebounds: 2, assists: 0, steals: 0, blocks: 0 },
      { id: 8, name: 'Connor Adams', position: 'Center', points: 11, rebounds: 1, assists: 0, steals: 0, blocks: 0 },
      { id: 9, name: 'Dylan Walker', position: 'Shooting Guard', points: 9, rebounds: 0, assists: 0, steals: 0, blocks: 0 },
      { id: 10, name: 'Brandon Hall', position: 'Power Forward', points: 7, rebounds: 0, assists: 0, steals: 0, blocks: 0 },
    ],
    coach: [
  ...
  members: [
    { id: 1, name: 'Liam Johnson', position: 'Center', points: 28, rebounds: 10, assists: 3, steals: 1, blocks: 1 },
    { id: 2, name: 'Ethan Brown', position: 'Small Forward', points: 25, rebounds: 8, assists: 4, steals: 2, blocks: 0 },
    ...
    { id: 6, name: 'Caleb Anderson', position: 'Small Forward', points: 16, rebounds: 3, assists: 1, steals: 0, blocks: 0 },
    { id: 7, name: 'Mason Taylor', position: 'Point Guard', points: 14, rebounds: 2, assists: 0, steals: 0, blocks: 0 },
    { id: 8, name: 'James Martin', position: 'Center', points: 12, rebounds: 2, assists: 0, steals: 0, blocks: 0 },
    { id: 9, name: 'Benjamin White', position: 'Shooting Guard', points: 9, rebounds: 1, assists: 0, steals: 0, blocks: 0 },
    { id: 10, name: 'Elijah Harris', position: 'Power Forward', points: 7, rebounds: 0, assists: 0, steals: 0, blocks: 0 },
  ],
  coach: [
...
},
{
  ...
  members: [
    ...
    { id: 2, name: 'Henry Adams', position: 'Small Forward', points: 27, rebounds: 9, assists: 3, steals: 1, blocks: 0 },
    { id: 3, name: 'Evan Davis', position: 'Point Guard', points: 24, rebounds: 6, assists: 5, steals: 2, blocks: 0 },
    { id: 4, name: 'Calvin Wilson', position: 'Shooting Guard', points: 21, rebounds: 5, assists: 3, steals: 1, blocks: 0 },
    { id: 5, name: 'Matthew Brown', position: 'Power Forward', points: 19, rebounds: 4, assists: 2, steals: 0, blocks: 0 },
    { id: 6, name: 'Nathan Clark', position: 'Small Forward', points: 16, rebounds: 3, assists: 1, steals: 0, blocks: 0 },
    { id: 7, name: 'Isaac Lewis', position: 'Point Guard', points: 14, rebounds: 2, assists: 0, steals: 0, blocks: 0 },
    { id: 8, name: 'Samuel Scott', position: 'Center', points: 12, rebounds: 2, assists: 0, steals: 0, blocks: 0 },
    { id: 9, name: 'Dylan Harris', position: 'Shooting Guard', points: 9, rebounds: 1, assists: 0, steals: 0, blocks: 0 },
    { id: 10, name: 'Tristan Young', position: 'Power Forward', points: 7, rebounds: 0, assists: 0, steals: 0, blocks: 0 },
  ],
  coach: [
